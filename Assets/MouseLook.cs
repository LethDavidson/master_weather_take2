...
public class MouseLook : MonoBehaviour {
	...
	void OnDrawGizmos () {
		//draws a line sowing where you're looking, size is x units
		Gizmos.color = Color.red;
		//this.GetComponentInChildren<Camera>.transform.TransformDirection (Vector3.forward); //find out how to make the laser only come outta camera. 
		Vector3 direction = transform.TransformDirection(Vector3.forward);;
		Gizmos.DrawRay (transform.position, direction); // draw a line from where i am, to where i'm looking. 
